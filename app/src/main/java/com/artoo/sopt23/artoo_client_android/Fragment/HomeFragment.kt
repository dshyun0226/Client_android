...
class HomeFragment : Fragment() {
    ...
    private fun selectedHomeTab(position: Int) {
        if (position == 0) {
            tv_top_navi_home_today_tab.setTextColor(resources.getColor(R.color.colorHomeBlack))
            tv_top_navi_home_theme_tab.setTextColor(resources.getColor(R.color.colorHomeGrey))
        } else {
            tv_top_navi_home_today_tab.setTextColor(resources.getColor(R.color.colorHomeGrey))
            tv_top_navi_home_theme_tab.setTextColor(resources.getColor(R.color.colorHomeBlack))
        }
